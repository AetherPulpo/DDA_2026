...
module tb_top_phy_all();
   ...
   //! Scope for output of 
   assign connect_srrc_to_dac_I = tb_top_phy_all.u_top_phy_all.connect_srrc_to_dac_I;
   assign connect_srrc_to_dac_Q = tb_top_phy_all.u_top_phy_all.connect_srrc_to_dac_Q;
