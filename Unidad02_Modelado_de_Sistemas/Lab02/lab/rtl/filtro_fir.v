module filtro_fir
  ...
  // Coeffs c = [-1 1/2 -1/4 1/8] //[fcut = 500Hz / 18khz / 8khz]
    assign coeff[ 0] = 8'h00;//8'hFF;//8'h00;
    assign coeff[ 1] = 8'h01;//8'h00;//8'hFF;
    assign coeff[ 2] = 8'h02;//8'hFF;//8'hFF;
    assign coeff[ 3] = 8'h03;//8'h00;//8'hFE;
    assign coeff[ 4] = 8'h05;//8'h03;//8'h00;
    assign coeff[ 5] = 8'h06;//8'hF7;//8'h07;
    assign coeff[ 6] = 8'h08;//8'h0D;//8'h10;
    assign coeff[ 7] = 8'h08;//8'h30;//8'h15;
    assign coeff[ 8] = 8'h08;//8'h0D;//8'h10;
    assign coeff[ 9] = 8'h06;//8'hF7;//8'h07;
    assign coeff[10] = 8'h05;//8'h03;//8'h00;
    assign coeff[11] = 8'h03;//8'h00;//8'hFE;
    assign coeff[12] = 8'h02;//8'hFF;//8'hFF;
    assign coeff[13] = 8'h01;//8'h00;//8'hFF;
    assign coeff[14] = 8'h00;//8'hFF;//8'h00;
